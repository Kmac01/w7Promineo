 ...
 *  
 *  to ensure cohesion I copied the "results" from week 10, as I assume it makes grading easier, and does not detract from current code
 * @author Promineo
 *
 */
...
//************************************************************************************************************************************************w
  ...
  private void updateProjectDetails() {
	// reference sheet 3.14.1
	  ...
	  String notes = getStringInput("Enter the actual hours [" + curProject.getNotes() + "]");
	  ...
	  //reference 4.14.5
	  //eclipse generated in projectservice. self explanatory
	  projectService.modifyProjectDetails(project);
	  
	  //end of section 1. checked for errors, with none found.
	  //rereading current project for changes

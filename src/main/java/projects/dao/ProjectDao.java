...
public class ProjectDao extends DaoBase {
	...
	public boolean modifyProjectDetails(Project project) {
		// reference page 4. Eclipse auto generated method. End of section 2, no errors
		// found.
	// @formatter:off
	String sql = ""
	...
	// @formatter:on
		...
		// obtaining connection, reference page 5.2
		try (Connection conn = DbConnection.getConnection()) {
			startTransaction(conn);
	...
	public boolean deleteProject(Integer projectId) {
		// case 5 method built for second section of coding project
